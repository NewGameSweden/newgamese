...
before_filter :configure_account_update_params, only: [:update]
  ...
  def create
    ...
    gibbon.lists("1797e3b3e9").members.create(body: {email_address: resource.email, status: "subscribed", merge_fields: {FNAME: resource.first_name, LNAME: resource.surname}})
  end
