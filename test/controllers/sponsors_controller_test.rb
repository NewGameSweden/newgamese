...
class SponsorsControllerTest < ActionController::TestCase
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post :create, sponsor: { description: @sponsor.description, link: @sponsor.link, logo: @sponsor.logo, name: @sponsor.name }
    end
  ...
  test "should update sponsor" do
    patch :update, id: @sponsor, sponsor: { description: @sponsor.description, link: @sponsor.link, logo: @sponsor.logo, name: @sponsor.name }
    assert_redirected_to sponsor_path(assigns(:sponsor))
  end
